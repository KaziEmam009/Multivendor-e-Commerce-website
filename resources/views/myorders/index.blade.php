                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm mt-1"  href="{{ route('invoice.download') }}">Invoice Download PDF</a>
                                            <a class="btn btn-warning btn-sm mt-1"  href="{{ route('invoice.download.excel') }}">Invoice Download Excel</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
